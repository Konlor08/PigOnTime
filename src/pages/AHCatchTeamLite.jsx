...
export default function AHCatchTeamLite() {
  ...
  return (
    <div className="min-h-screen bg-emerald-50">
      {/* ---- Header (ปรับเฉพาะหน้าตา/ปุ่ม) ---- */}
      <header className="bg-emerald-600 text-white">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          <h1 className="text-2xl font-semibold">
            ยืนยันจำนวนทีมจับสุกร (คิววันนี้ → +7 วัน)
          </h1>
          <Link
            to="/ah"
            aria-label="กลับหน้า Animal husbandry"
            className="inline-flex items-center rounded-lg bg-emerald-700/90 px-5 py-2
                       text-white font-medium shadow-sm hover:bg-emerald-700
